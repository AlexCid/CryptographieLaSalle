...
#slide[
    ...
    Le Graal : un adversaire interceptant un message chiffé *ne peut pas retrouver la moindre information* concernant le message clair
      ...
      #sym.arrow.r La sécurité est *inconditionnelle* (ne dépend pas de la puissance de calcul)
]
...
#slide[
    ...
    - Valeurs des S-Box : paraissent arbitraires (mais en fait : la NSA a bien fait les choses ! #emoji.thumb.up pour une fois...)
